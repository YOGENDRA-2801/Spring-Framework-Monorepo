package in.yoy.HbrntXmlMap.main;
...
import in.yoy.HbrntXmlMap.beans.Students;
...
//    	CRT CONFIG (TO_CONFIGURE_&_MANAGE_HBRNT_SETTINGS) , SF(TO_CREATE_SESSION) & SESSION OBJECT(TO_PERFORM_OPERATION)
		...
		cfg.configure("/in/yoy/HbrntXmlMap/resources/hibernate.cfg.xml"); // load config detail
