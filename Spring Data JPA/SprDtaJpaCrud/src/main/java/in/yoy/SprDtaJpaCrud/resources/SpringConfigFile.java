package in.yoy.SprDtaJpaCrud.resources;
...
@EnableJpaRepositories (basePackages = { "in.yoy.SprDtaJpaCrud.repository" } )
@EnableTransactionManagement
@ComponentScan ( basePackages = { "in.yoy.SprDtaJpaCrud" } )
@Configuration
public class SpringConfigFile {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory () {
		...
		lcemfb.setPackagesToScan("in.yoy.SprDtaJpaCrud.entity");
